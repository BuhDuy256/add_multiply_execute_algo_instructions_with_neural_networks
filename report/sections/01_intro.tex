...
\begin{frame}{Đóng góp chính của bài báo}
  ...
  \begin{enumerate}
    \item \textbf{Algorithmic Template Representation:} Dữ liệu huấn luyện dạng "template" - số lượng chỉ tăng \textbf{logarithmic}.
    \item \textbf{Provable Exact Learnability:} Ensemble mạng 2 lớp ($n_h \to \infty$) học \textbf{chính xác} với xác suất cao.
  \end{enumerate}
