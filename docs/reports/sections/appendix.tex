...
Định lý \textit{Sherman-Morrison} (1950) là công cụ quan trọng để tính nghịch đảo của ma trận khi có sự thay đổi hạng 1 (rank-1 update). Đây là nền tảng cho việc phân tích ma trận NTK có cấu trúc \textbf{ma trận đơn vị + rank-1 noise}.
