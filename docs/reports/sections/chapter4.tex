...
\begin{itemize}
    ...
    \item \textbf{Tính hiệu quả:} Tính toán dạng tường minh thay vì tối ưu hóa iterative
...
\begin{itemize}
    ...
    \item \textbf{Tập kiểm tra:} 1000 vector kiểm thử được sinh ngẫu nhiên, mỗi vector có $n_{\hat{x}} = 2$ phần tử khác không (vector thưa)
...
\begin{itemize}
    \item Khi kích thước ensemble tăng lên, độ chính xác tiến dần đến 100\% (độ chính xác tuyệt đối)
...
Do sử dụng các bất đẳng thức trường hợp xấu nhất, ngưỡng này có tính chất \textbf{bảo thủ cao}. Trong thực tế:
\begin{itemize}
