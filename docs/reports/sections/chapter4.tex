...
\begin{itemize}
    ...
    \item \textbf{Tài nguyên tính toán:} Số Kích thước tập hợp các mô hình cần thiết nằm trong khả năng của phần cứng hiện có
...
\subsection{Độ chính xác theo kích thước của tập hợp các mô hình}
...
\begin{figure}[h]
    ...
    \caption{Thực nghiệm 1 (trái) trình bày số mô hình cần thiết để đạt độ chính xác 90\% theo kích thước đầu vào $k$, so sánh với ngưỡng lý thuyết từ công thức tinh số lượng mô hình tối thiểu. Thực nghiệm 2 (phải) trình bày độ chính xác theo số mô hình với các kích thước đầu vào $k$ khác nhau.}
...
\begin{itemize}
    \item Bất đẳng thức tập trung cho tổng các biến ngẫu nhiên con-Gaussian
...
\begin{itemize}
    \item Các phân phối thực tế thường tốt hơn giả định trường hợp xấu nhất
