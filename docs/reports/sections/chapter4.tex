...
\begin{itemize}
    ...
    \item Với mỗi giá trị $l$, tập huấn luyện bao gồm tất cả các mẫu (template) cần thiết cho thuật toán tương ứng
...
\begin{itemize}
    ...
    \item Sự phù hợp này xác nhận rằng công thức tính độ phức tạp tập hợp (ensemble complexity) trong Công thức (8) là chính xác
\end{itemize}
...
\begin{itemize}
    \item \textbf{Tập huấn luyện:} Bao gồm $2n$ mẫu (template) tương ứng với tất cả các ánh xạ vị trí của hoán vị
...
\begin{enumerate}
    ...
    \item \textbf{Độ phức tạp tập hợp:} Công thức (8) cung cấp ngưỡng chặn trên hợp lệ và có tính bảo thủ
\end{enumerate}
