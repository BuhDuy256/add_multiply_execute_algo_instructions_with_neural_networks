...
% TODO: Chèn hình Figure 5 từ paper
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.8\textwidth]{figures/variance_mean_ratio.pdf}
...
% TODO: Chèn hình Figure 7 từ paper (Experiment 1 và Experiment 2)
% \begin{figure}[h]
%     \centering
%     \begin{minipage}{0.48\textwidth}
%         \includegraphics[width=\textwidth]{figures/experiment1.pdf}
%     \end{minipage}
%     \hfill
%     \begin{minipage}{0.48\textwidth}
%         \includegraphics[width=\textwidth]{figures/experiment2.pdf}
%     \end{minipage}
