...
\begin{enumerate}
    \item \textbf{Dữ liệu có tương quan:} Nghiên cứu khả năng \textit{exact learnability} khi dữ liệu huấn luyện có tương quan thay vì tuân theo giả định trực giao nghiêm ngặt.
