...
\begin{itemize}
    \item \textbf{Biểu diễn thuật toán dưới dạng template:} Mỗi quy tắc cấp độ bit của thuật toán được mã hóa thành một vector mẫu riêng biệt, cho phép cô lập các quy tắc logic và tạo ra cấu trúc dữ liệu phù hợp cho việc áp dụng cơ chế khớp mẫu.
    ...
    \item \textbf{Góc nhìn giáo dục:} Báo cáo này tổng hợp và trình bày lại các kết quả từ nghiên cứu gốc, giúp người đọc tiếp cận các khái niệm phức tạp như NTK, infinite-width limit, và khớp mẫu một cách có hệ thống.
\end{itemize}
