...
\begin{enumerate}
    ...
    \item \textbf{Kiến trúc có độ dài thay đổi:} Mở rộng khung lý thuyết NTK sang các kiến trúc có khả năng xử lý đầu vào với độ dài thay đổi như Transformer, RNN, hoặc GNN trên đồ thị có bậc bị chặn.
